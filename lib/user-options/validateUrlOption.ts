...
/**
 * @alpha
 * @param options - User Options from the inside of validate options
 ...
 * @param urlKey - [ default='url' ] The key of the url inside the user options
 ...
 * @param otherValidationErrors - [ default=[] ] Allows you to pass in
 ...
 * ```
 *
 * @returns Any URL based Validation Error found in relation to the user option
 * ```
